...
<section id="wrapper" class="login-register">
  ...
  <?php
				...
				?>
				<center> <font size="+4"><b>Lunar Stress</b></font></center>
      ...
      <form class="form-horizontal form-material" id="loginform" method="post">
        ...
        <div class="form-group">
		 ...
		 <div class="form-group">
          ...
          <div class="col-xs-12">
            <button type="submit" name="doLogin" class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit">Login</button>
          </div>
        </div>
